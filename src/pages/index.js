...
const IndexPage = () => {
  const portraits = [
    ...
    //   src: "static/Vitoriano-Fidel-Padron-Gonzalez.jpg",
    ...
    //   src: "/static/b8e215336bbfbc2d2e7cf4425da55038/46afd/Juan-Francisco-Quintero-Padron-2-683x1024.jpg",
    ...
    <StaticImage
      src="../images/silbadores/Vitoriano-Fidel-Padron-Gonzalez.jpg"
      alt="Vitoriano-Fidel-Padron-Gonzalez"
      width={width}
    />,
    <StaticImage
      src="../images/silbadores/Vidal-Acosta-Gutierrez.jpg"
      alt="Vidal-Acosta-Gutierrez"
      width={width}
    />,
    <StaticImage
      src="../images/silbadores/Adela-Padron-Perez.jpg"
      alt="Adela-Padron-Perez"
      width={width}
    />,
    <StaticImage
      src="../images/silbadores/Andres-Gonzalez-Padron.jpg"
      alt="Andres-Gonzalez-Padron"
      width={width}
    />,
    <StaticImage
      src="../images/silbadores/Antonio-Morales-Morales-2.jpg"
      alt="Antonio-Morales-Morales"
      width={width}
    />,
    <StaticImage
      src="../images/silbadores/Aurelio-Cabrera-Acosta-2.jpg"
      alt="Aurelio-Cabrera-Acosta"
      width={width}
    />,
    <StaticImage
      src="../images/silbadores/Benito-Armas-Hernandez-2.jpg"
      alt="Benito-Armas-Hernandez"
      width={width}
    />,
    <StaticImage
      src="../images/silbadores/Carlos-Alberto-Gutierrez-Sanchez-2.jpg"
      alt="Carlos-Alberto-Gutierrez-Sanchez"
      width={width}
    />,
    <StaticImage
      src="../images/silbadores/Emiliano-Fernandez-Armas.jpg"
      alt="Emiliano-Fernandez-Armas"
      width={width}
    />,
    <StaticImage
      src="../images/silbadores/Esteban-Padron-Quintero.jpg"
      alt="Esteban-Padron-Quintero"
      width={width}
    />,
    <StaticImage
      src="../images/silbadores/Felix-Zamora-Gutierrez.jpg"
      alt="Felix-Zamora-Gutierrez"
      width={width}
    />,
    <StaticImage
      src="../images/silbadores/Fernando-Padron-Casanas-2.jpg"
      alt="Fernando-Padron-Casanas"
      width={width}
    />,
    <StaticImage
      src="../images/silbadores/Francisco-Armas-Gonzalez.jpg"
      alt="Francisco-Armas-Gonzalez"
      width={width}
    />,
    <StaticImage
      src="../images/silbadores/Francisco-Quintero-Morales.jpg"
      alt="Francisco-Quintero-Morales"
      width={width}
    />,
    <StaticImage
      src="../images/silbadores/IMG-20210814-WA0038-768x1024.jpg"
      width={width}
    />,
    <StaticImage
      src="../images/silbadores/Jose-Luis-Acosta-Castaneda-2.jpg"
      alt="Jose-Luis-Acosta-Castaneda"
      width={width}
    />,
    <StaticImage
      src="../images/silbadores/Juan-Francisco-Quintero-Padron-2-683x1024.jpg"
      alt="Juan-Francisco-Quintero-Padron"
      width={width}
    />,
    <StaticImage
      src="../images/silbadores/Juan-Francisco-Quintero-Perez.jpg"
      alt="Juan-Francisco-Quintero-Perez"
      width={width}
    />,
    <StaticImage
      src="../images/silbadores/Lalo-Fonte-Armas-2.jpg"
      alt="Lalo-Fonte-Armas"
      width={width}
    />,
    <StaticImage
      src="../images/silbadores/Manuel-Padron-Quintero-2.jpg"
      alt="Manuel-Padron-Quintero"
      width={width}
    />,
    <StaticImage
      src="../images/silbadores/Maria-Reyes-Gutierrez-Quintero.jpg"
      alt="Maria-Reyes-Gutierrez-Quintero"
      width={width}
    />,
    <StaticImage
      src="../images/silbadores/Pablo-Martin-Zamora-2.jpg"
      alt="Pablo-Martin-Zamora"
      width={width}
    />,
    <StaticImage
      src="../images/silbadores/Pedro-Machin-Padron-2.jpg"
      alt="Pedro-Machin-Padron"
      width={width}
    />,
    <StaticImage
      src="../images/silbadores/Rafael-Castaneda-Rodriguez-2.jpg"
      alt="Rafael-Castaneda-Rodriguez"
      width={width}
    />,
    <StaticImage
      src="../images/silbadores/Ramon-Angel-Mendez-Padron-2.jpg"
      alt="Ramon-Angel-Mendez-Padron"
      width={width}
    />,
    <StaticImage
      src="../images/silbadores/Remedios-Morales-Gonzalez-2.jpg"
      alt="Remedios-Morales-Gonzalez"
      width={width}
    />,
    <StaticImage
      src="../images/silbadores//Rosario-Morales-Gonzalez-2.jpg"
      alt="Rosario-Morales-Gonzalez"
      width={width}
    />,
    <StaticImage
      src="../images/silbadores/Trinidad-Padron-Peraza.jpg"
      alt="Trinidad-Padron-Peraza"
      width={width}
    />,
    <StaticImage
      src="../images/silbadores/Epifanio-Zamora-Machin-2.jpg"
      alt="Epifanio-Zamora-Machin"
      width={width}
    />,
    <StaticImage
      src="../images/silbadores/Emiliano-Garcia-Garcia-2.jpg"
